...
<tbody>
 ...
 <tr>
  ...
  <td colspan=4><input type="text" name="razon_soc" size=40 maxlength=50 value="<?php echo $razon_soc ?>">
...
?>
  ...
  <td>
    <input type="text" value="<?php echo $curp ?>" name=curp size="<?php echo $MAXCURP ?>"
    maxlength="<?php echo $MAXCURP ?>">
 ...
 <tr>
  ...
  <td><input type="text" name="dom_ext" size=15 maxlength=15 value="<?php echo $dom_ext ?>">
  <td align="right">Interior</td>
  <td>
    <input type="text" name=dom_int size=4 maxlength=7 value="<?php echo $dom_int ?>">

 </tr>
 <tr>
  <td align="right">Colonia:
  <td colspan=4>
    <input type="text" name="dom_col" size=40 value="<?php echo $dom_col ?>">
  <td align="right">C.P.
  <td colspan=3>
    <input type="text" name="dom_cp" size=5 maxlength=5 value=<?php echo $dom_cp ?>>

 </tr>
 <tr>
  <td align="right">Ciudad
  <td colspan=4>
    <input type="text" name="dom_ciudad" size=40 value=<?php echo "\"$dom_ciudad\""?>>
