...
<tr>
  ...
  <td>
    <input type="checkbox" name="codigo[]" value="<?php echo $ren->codigo ?>">
  </td>
  <td><?php echo htmlentities($ren->codigo) ?></td>
  <td><?php echo htmlentities($ren->descripcion) ?></td>
  <td><?php echo $nm_deptos[$ren->id_depto] ?></td>
</tr>
<?php
   }
}
